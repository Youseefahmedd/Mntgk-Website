    ...
    <footer className={styles.footer} id="site-footer">
      <div className="container">
        <div className={styles.footerGrid}>
          ...
          <div>
            <h4 className={styles.footerTitle}>{dict.footer.quickLinks}</h4>
          ...
          <div>
            <h4 className={styles.footerTitle}>{dict.footer.contactUs}</h4>
            <div className={styles.footerLinks}>
              <a href="https://wa.me/966535355628" target="_blank" rel="noopener noreferrer" className={styles.footerLink}>
              ...
              <a href="mailto:hello@mntgk.com" className={styles.footerLink}>
        ...
        <div className={styles.footerBottom}>
          <p className={styles.footerCopy}>© {new Date().getFullYear()} Mntgk. {dict.footer.rights}</p>
