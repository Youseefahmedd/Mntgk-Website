...
export default function CTABanner({ dict, lang }) {
  return (
    <section className={styles.cta} id="cta-banner">
      ...
      <div className="container">
        <div className={`${styles.ctaContent} reveal`}>
          <h2 className={styles.ctaTitle}>{dict.cta.title}</h2>
          <p className={styles.ctaSubtitle}>{dict.cta.subtitle}</p>
          <div className={styles.ctaBtns}>
            <Link href={`/${lang}/contact`} className="btn btn-primary btn-lg">
              {dict.cta.button}
            </Link>
            <a
              href="https://wa.me/966535355628"
              target="_blank"
